    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('rol.actualizar',$rol) }}">
            ...
            <div>
                ...
                <x-jet-input id="nombre" class="block mt-1 w-full" type="text" name="nombre" value="{{ $rol->rol_nombre }}" required autofocus autocomplete="nombre" />
            </div>

            <div>
                <x-jet-label for="descripcion" value="{{ __('Descripcion') }}" />
                <textarea name="descripcion" id="descripcion" cols="43" rows="5" value="{{ $rol->rol_descripcion }}"></textarea>
            </div>

    ...
    <div class="pt-4 pb-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg ">
                ...
                <br><br>
                <form method="POST" class="flex items-center justify-end my-3" role="search" action="{{route('prestador.search')}}">
                    @csrf
                            ...
                            @foreach ($lista as $item)
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">
                                        <x-jet-button class="ml-2">
                                            <a href="{{route('prestador.modificar',$item->ID)}}">
                                                {{ __('Modificar') }}
                                            </a>
                                        </x-jet-button>
                                    </td>
                                    <td>
                                        <x-jet-button class="ml-2">
                                            <a href="{{route('prestador.eliminar',$item->ID)}}">
                                                {{ __('Eliminar') }}
                                            </a>
                                        </x-jet-button>
                                    </td>

<x-app-layout>
    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('prestador.borrar',$prestador) }}">
            @csrf
            ...
            <div>
                ...
                <x-jet-input id="matricula" class="block mt-1 w-full" disabled type="text" name="matricula" value="{{ $prestador->prest_matricula }}" required autofocus autocomplete="matricula" />
            </div>
